...
import { replacePlaceholders, conversorDeIndicesParaAlternativas } from "./util.js"
...
export class LayoutAvaliacao {
    ...
    associacoesHtml(associacoes) {
        ...
        if (associacoes) {
            ...
            function buildAssociacao(coluna) {
                return coluna.map(
                    (itemColuna) => {
                        return `
                      <div class="linha-alternativa">
            ...
            return `<div class="duas-colunas">
						<div>
							${buildAssociacao(associacoes.coluna1)}
						</div>
						<div>
                            ${buildAssociacao(associacoes.coluna2)}
						</div>
					</div>
